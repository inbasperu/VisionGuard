...
static const char camera_resolution_message[] =
    "Optional. Set camera resolution in format WxH.";
...
static const char facial_landmarks_model_message[] =
    "Required. Path to an .xml file with a trained Facial Landmarks Estimation "
    "model.";
static const char eye_state_model_message[] =
    "Required. Path to an .xml file with a trained Open/Closed Eye Estimation "
    "model.";
static const char target_device_message[] =
    "Optional. Target device for Gaze Estimation network (the list of "
    "available devices is shown below). "
    "Use \"-d HETERO:<comma-separated_devices_list>\" format to specify HETERO "
    "plugin. "
    "The demo will look for a suitable plugin for a specified device. Default "
    "value is \"CPU\".";
static const char target_device_message_fd[] =
    "Optional. Target device for Face Detection network (the list of available "
...
static const char target_device_message_hp[] =
    "Optional. Target device for Head Pose Estimation network (the list of "
    "available devices is shown below). "
    "Use \"-d HETERO:<comma-separated_devices_list>\" format to specify HETERO "
    "plugin. "
    "The demo will look for a suitable plugin for a specified device. Default "
...
static const char target_device_message_lm[] =
    ...
    "(the list of available devices is shown below). Use \"-d "
    "HETERO:<comma-separated_devices_list>\" format to specify HETERO plugin. "
    "The demo will look for a suitable plugin for a specified device. Default "
    "value is \"CPU\".";
...
static const char thresh_output_message[] =
    "Optional. Probability threshold for Face Detector. The default value is "
    "0.5.";
static const char raw_output_message[] =
    "Optional. Output inference results as raw values.";
static const char fd_reshape_message[] =
    "Optional. Reshape Face Detector network so that its input resolution has "
    "the same aspect ratio as the input frame.";
static const char no_show_message[] = "Optional. Don't show output.";
static const char utilization_monitors_message[] =
